...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahPengaduanModal">
        Tambah Pengaduan
      </button>

      <!-- Modal untuk tambah pengaduan -->
      <div class="modal fade" id="tambahPengaduanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- Form tambah pengaduan di sini -->
              <?= form_open_multipart('Masyarakat/PengaduanController'); ?>
              <div class="form-group">
                <label for="isi_laporan">Isi Laporan</label>
                <textarea name="isi_laporan" id="isi_laporan" cols="30" rows="5" class="form-control"></textarea>
              </div>
        ...
        <?php foreach ($data_pengaduan as $dp) : ?>
          <tr>
            ...
            <td>
              <?php
              if ($dp['status'] == '0') :
                echo '<span class="badge badge-secondary">Menunggu Petugas Mengerjakan</span>';
              ...
              elseif ($dp['status'] == 'pending') :
                echo '<span class="badge badge-danger">Pengaduan di pending</span>';
              else :
                echo '-';
              endif;
              ?>
            ...
            <?php else : ?>
              <td><a href="<?= base_url('Masyarakat/PengaduanController/pengaduan_detail/' . $dp['id_pengaduan']) ?>" class="btn btn-success"><i class="fas fa-fw fa-eye"></i></a></td>
            <?php endif; ?>
